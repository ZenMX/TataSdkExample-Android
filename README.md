...
latest version `1.0.1.17-SNAPSHOT`
...
implementation 'com.m.x.tata.sdk:player:1.0.1.17-SNAPSHOT'
...
* correct event parameter, videoId -> videoID
...
* Disable screen shot & record when playback
